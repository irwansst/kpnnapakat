...
include "../../plugin/pengaduan.php";

 $sql=" select * from pengaduan WHERE tgl BETWEEN '$mulai' AND '$selesai';";
...
if(!$hsl)
		...
		$pdf->SetWidths(array(10,20,30,30,30,30,30,30,30,20,20,30,30));
		
		$aa = 'NO'; 
		$bb = 'TANGAL PENERIMA LAPDU';
		$cc = 'SUMBER LAPDU';
		$dd = 'TERLAPOR';
		$ee = 'URAIAN SINGKAT PENGADUAN';
		$ff = 'TELAAHAN';
		$gg = 'LAPORAN HASIL KLARIFIKASI';
		$hh	 = 'LAPORAN HASIL INSPEKSI KASUS';
		$ii  = 'KAJATI/ INSPEKTUR';
		$jj  = 'JAMWAS';
		$kk  = 'JAKSA AGUNG/ WAJA';
		$ll  = 'PUTUSAN';
