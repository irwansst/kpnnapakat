...
include "../../plugin/var.php";
    ...
    echo "<h1>Laporan SURAT perintah</h1>
			<div class='line'></div>
			<div class='box'>";
	echo "
		  <b>LAPORAN SURAT PERINTAH HARI INI</b><br>
		  <a href=pdf_perintah_sekarang.php target=_blank class=button>Proses laporan</a> 
		  
		  <form method=POST action='pdf_perintah.php' target=_blank>
          <br><br><b>LAPORAN SURAT PERINTAH PER PERIODE</b><br>
		  <table>
		  <tr>
