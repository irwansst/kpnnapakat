...
$selesai	= $_POST[tgl2];
$no = 1;
$kue=mysql_query("SELECT jSurat AS jenis, COUNT(nAgenda) AS jumlah FROM sKeluar where tKeluar BETWEEN '$mulai' AND '$selesai'  GROUP BY jSurat ");
$sql=mysql_query("SELECT * FROM skeluar where tKeluar BETWEEN '$mulai' AND '$selesai' ");
?>
...
<?php
echo '<p>DAFTAR SURAT KELUAR PER TANGGAL: '.$mulai.' s.d. '.$selesai.'</p>
...
<pagebreak />
<?php
echo '<p>REKAPITULASI SURAT KELUAR PER: '.$mulai.' s.d. '.$selesai.' </p>
